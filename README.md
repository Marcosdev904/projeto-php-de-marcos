...
# LOGOUT:
realiza o logout do usuário. Ele verifica se a cessão existe e caso exista inicializa ela usando  session_start();. Logo após ele destrói a sessão e levando o usuário de volta para a página de login.
